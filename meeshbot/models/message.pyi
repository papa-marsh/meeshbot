...
class GroupMeMessageQuery(Query[GroupMeMessage]):
    ...
    def filter(
        self,
        *args: Any,
        attachments: <class 'list'> | None = None,
        attachments__in: list[<class 'list'>] | None = None,
        ...
        timestamp__gt: int | None = None,
        timestamp__gte: int | None = None,
        timestamp__lt: int | None = None,
        timestamp__lte: int | None = None,
        timestamp__between: tuple[int, int] | None = None,
        timestamp__range: int | None = None,
        timestamp__in: list[int] | None = None,
